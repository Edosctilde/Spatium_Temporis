...
#
#T = Seq1.play(T, [cRnd, 100, 150], 500, 0.1, df = [cLin, 600, 40], dt = 0.006)
...
Seq1.play(T, [cRnd, 660, 700], 100, [0.05, 0.2, 0.1, 0.15], dt = 0.3)
T = Seq3.play(T , [cRnd, 400, 450], 50, [cLin, 0.05, 0.12], dt = 3)
#soffio
